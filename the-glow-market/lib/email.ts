...
export async function sendOrderConfirmation({
  ...
  const introText = hasCurso && !hasProductoFisico
    ? requiereCuenta
      ? `
      <p style="font-size: 14px; color: #1a2340; opacity: 0.7; margin: 0 0 16px 0; line-height: 1.6;">Tu compra fue confirmada.</p>
      <p style="font-size: 14px; color: #1a2340; opacity: 0.7; margin: 0 0 32px 0; line-height: 1.6;">Para acceder a tu curso, creá gratis tu cuenta en The Glow Market con este mismo email. En cuanto inicies sesión, el curso se activa automáticamente.</p>
    `
      : `
