...
<body style="margin: 0; padding: 0; background-color: #f5f0eb; font-family: 'Georgia', serif;">
  <div style="max-width: 580px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: #ffffff; padding: 48px 40px; border-radius: 2px;">
      <p style="font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; color: #1a2340; opacity: 0.5; margin: 0 0 16px 0;">Confirmación de pedido</p>
      <h1 style="font-size: 28px; font-weight: 300; color: #1a2340; margin: 0 0 8px 0; letter-spacing: 0.05em;">Hola, ${nombreCliente}</h1>
      <p style="font-size: 14px; color: #1a2340; opacity: 0.6; margin: 0 0 32px 0; line-height: 1.6;">Recibimos tu pedido y ya está siendo preparado con todo el cuidado que merece.</p>
      <div style="border-top: 1px solid #e8e0d8; margin-bottom: 24px;"></div>
      <p style="font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: #1a2340; opacity: 0.4; margin: 0 0 24px 0;">Pedido #${ordenId.slice(0, 8).toUpperCase()}</p>
      ...
      <p style="font-size: 13px; color: #1a2340; opacity: 0.6; line-height: 1.7; margin: 0;">Te avisaremos cuando tu pedido esté en camino. Si tenés alguna pregunta, respondé este mail o escribinos por Instagram.</p>
    </div>
