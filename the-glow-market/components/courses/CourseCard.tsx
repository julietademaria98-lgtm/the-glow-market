      ...
      >
        ...
        <div className="p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between mt-2 pt-4 border-t border-glow-navy/10">
            ...
            {hasAccess ? (
              <Link href="/mi-curso">
                <Button variant="primary" size="sm">Acceder</Button>
              </Link>
            ) : (
              <button
                onClick={() => setDrawerOpen(true)}
                className="font-montserrat text-[10px] tracking-[0.2em] uppercase bg-glow-navy text-white px-4 py-2.5 hover:bg-glow-blue transition-colors duration-300"
              >
                Más info
              </button>
            )}
